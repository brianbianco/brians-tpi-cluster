...
--node-ip 192.168.4.183: Specifies the IP address for the node.
...
`curl -sfL https://get.k3s.io | INSTALL_K3S_EXEC="server --write-kubeconfig-mode 644 --disable servicelb --node-ip 192.168.4.183 --disable-cloud-controller --kubelet-arg=allowed-unsafe-sysctls=net.ipv4.ip_forward" sh -`
